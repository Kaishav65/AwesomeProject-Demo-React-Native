  ...
  return (
    ...
    >
      ...
      <View style={{ justifyContent: "center", marginTop: 50 }}>
        <Text style={{ fontSize: 25 }}>Where do you work?</Text>
      ...
      >
        ...
        >
           {/* <Text style={{fontSize:18,fontWeight:"500",marginLeft:16}}>Inmobi</Text> */}
           <TextInput placeholder="first name" style={{fontSize:18,fontWeight:"500",marginLeft:16}} />
